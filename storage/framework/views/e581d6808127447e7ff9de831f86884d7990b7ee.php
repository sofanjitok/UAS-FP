    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-6">
            <div class="float-right">
                <a href="<?php echo e(route('post.create')); ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Add new Post</a>
            </div>
        ...
        <tbody>
          <?php $__empty_1 = true; $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              <tr>
              <th><?php echo e($post->nama); ?></th>
              <td><?php echo e($post->nip); ?></td>
...
<?php endif; ?> 
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Febrian Yudho\Desktop\laravel-crud-system-master\resources\views//pages/post/view.blade.php ENDPATH**/ ?>